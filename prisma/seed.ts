...
async function main() {
  ...
  const [alice, bob, carol] = await Promise.all([
    prisma.user.create({
      data: { email: "alice@example.com", logtoId: "logto_alice_123" },
    }),
    prisma.user.create({
      data: { email: "bob@example.com", logtoId: "logto_bob_456" },
    }),
    prisma.user.create({
      data: { email: "carol@example.com", logtoId: "logto_carol_789" },
    }),
  ]);
    ...
    data: {
      ...
      messages: {
        create: [
          ...
          {
            content:
              "Nuxt 3 adalah framework full-stack modern berbasis Vue 3.",
            role: "assistant",
          },
        ],
      },
    ...
    data: {
      ...
      messages: {
        create: [
          ...
          {
            content:
              "Tentu! Bahan: nasi, bawang putih, kecap, telur, ayam. Masak bawang, tambahkan ayam, telur, lalu nasi dan kecap.",
            role: "assistant",
          },
        ],
      },
