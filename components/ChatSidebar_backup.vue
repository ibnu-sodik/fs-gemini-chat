...
async function handleDeleteConfirm(data: { sessionId: string; isActiveSession: boolean }) {
  showDeleteModal.value = false;
  sessionToDelete.value = null;
...
<template>
  <div class="relative">
    ...
    <aside
      ref="sidebarRef"
      :class="[
        'fixed lg:relative inset-y-0 left-0 z-50 w-80 bg-white border-r border-gray-200 flex flex-col h-full transition-transform duration-300 ease-in-out lg:translate-x-0',
