    ...
    >
      ...
      >
        <div class="text-center max-w-md mx-auto p-8">
          <div
            class="w-16 h-16 bg-gradient-to-bl from-gray-100 to-gray-500 rounded-full flex items-center justify-center mx-auto mb-4"
          >
            <svg
          ...
          <p class="text-gray-600 mb-6">
            Type a message below to start chatting with Gemini AI. Continue your
